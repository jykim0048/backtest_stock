...
_MACRO_KEYWORDS = (
    ...
    "천연가스", "곡물", "비트코인", "미-", "북한",
    # 정책 주체(2026-08-06): '백악관, 중국산 광통신 규제' 촉매가 화이트리스트 미포함으로
    # sp 강등돼 S&P 배지로 표기된 사례 — 정책·규제 뉴스의 기관 주체는 순수 매크로로 인정.
    "백악관", "트럼프", "행정부", "의회", "상원", "하원", "재무부", "상무부", "규제",
)
...
- 각 pick 필드:
  ...
  name: 표 첫 칸에 들어갈 **뉴스의 실제 주체(2~12자)** — 그 사건의 '주어'를 그대로 쓴다.
        ...
        **같은 원인의 매크로 스토리도 표기 통일** — 한 사건(예: 미-이란 갈등)이 유가·지정학
        등 여러 각도로 보도돼도 주체명은 reported 의 표기 하나로(예: '미-이란') 통일하고,
        유가 급등 같은 파생 영향은 summary 에 서술한다('이란'·'국제유가'·'미-이란'으로
        쪼개 쓰지 말 것).
